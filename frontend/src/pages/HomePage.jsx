  ...
  return (
    <div className='border w-full h-screen sm:px-[15%] sm:py-[5%]'>
        <div className={`backdrop-blur-xl border-2 border-gray-600 rounded-2xl overflow-hidden h-[100%] flex justify-around relative`}>
            ...
            <ChatContainer selecteduser={selecteduser} setselecteduser={setselecteduser} className=" p-4 flex-grow"/>
            <RightSideBar selecteduser={selecteduser} setselecteduser={setselecteduser} className=" p-4 w-[20%]"/>
